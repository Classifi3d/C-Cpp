...
int main() {
	float v[MAX][MAX];
	int n=3, m=3;
	printf("Read from the keyboard the elements of 3 by 3 matrix with float elements.The program will rearrange the rows descreasingly by the sum of the columns.\n");
	readMatrix(v, n, m);
	displayMatrix(v, n, m);
